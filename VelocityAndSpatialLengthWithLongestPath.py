...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 24 16:04:44 2018
...
#resultSubgraphList = returnSubgraph(resultGraph)

#test = nx.Graph(resultSubgraphList[0])
#print("finally")
#for node in test.node:
#    print(test.node[node]['pos'])
#
#
##
#for j in resultSubgraphList:
#    
#    if len(resultSubgraphList) == 1:
#        H5 = resultSubgraphList[0].copy()
#    else:    
#        H5 =  nx.Graph(resultSubgraphList.subgraph(j))
#    
#    e_p,j_p = returnEndpointsAndJunction(H5)
#    
#    longestPath = 0 
#    
#    for end1 in e_p:
#        for end2 in e_p:
#            path = nx.shortest_simple_paths(H5, source=end1, target=end2, weight='V_length')
#            
#    
